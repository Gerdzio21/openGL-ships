...
public:
    ...
    */
    ...
    virtual void displayScene() {
        ...
        shipContainerViewer->drawContainer( boardConfiguratorModel->getShipContainerController()->getShips(),boardConfiguratorModel->getShipContainerController()->getSelectedShipIndex());
